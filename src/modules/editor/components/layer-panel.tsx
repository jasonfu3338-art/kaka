...
import { layers } from "../data/editor-mock-data";
...
export function LayerPanel({ open, onClose }: LayerPanelProps) {
  return (
    <>
      ...
      />
      <aside
        className={`fixed left-3 top-24 z-50 h-[calc(100dvh-178px)] w-[74%] max-w-[292px] rounded-[28px] border border-white/12 bg-slate-950/72 p-4 text-white shadow-[0_26px_90px_rgba(0,0,0,0.72),0_0_40px_rgba(59,130,246,0.22)] backdrop-blur-2xl transition duration-300 ${
